...
public class MainActivity extends Activity implements Constants, MeetingServiceListener, ZoomSDKInitializeListener {
	...
	public final static int TAB_NEW_MEETING = 4;
	...
	private Button btnTabNewMeeting;
	...
	private void setupTabs() {
		...
		btnTabNewMeeting = findViewById(R.id.btnTabNewMeeting);
		btnTabPage2 = (Button)findViewById(R.id.btnTabPage2);
		
		selectTab(TAB_WELCOME);

		btnTabNewMeeting.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				selectTab(TAB_NEW_MEETING);
			}
		});
	...
	private void selectTab(int tabId) {
		if(tabId == TAB_WELCOME) {
			...
			btnTabNewMeeting.setSelected(false);
			...
			ZoomSDK.getInstance().getZoomUIService().setNewMeetingUI(MyNewMeetingActivity.class);
			...
			if(meetingService.getMeetingStatus() == MeetingStatus.MEETING_STATUS_IDLE){
				...
				btnTabWelcome.setSelected(false);
				btnTabPage2.setSelected(false);
				btnTabNewMeeting.setSelected(true);
